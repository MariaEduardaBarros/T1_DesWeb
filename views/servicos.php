...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg .d-print-none navbar-light bg-light">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="container">
                    <div class="row mb-2"> 
                        <div class="col-md-10"><h5>Serviços</h5></div>
                        <div class="col md-2">
                            <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#modalExemplo">Adicionar Serviço</button>
